...
func DefaultSiteSettings() SiteSettings {
	return SiteSettings{
		...
		AboutStats:     []HomeStat{{Value: "435K+", Label: "Combined audience across platforms"}, {Value: "244.8K", Label: "TikTok followers"}, {Value: "177.8K", Label: "Facebook community"}, {Value: "2.4M", Label: "TikTok likes on the skits"}},
		...
		SocialProfiles: []SocialProfile{{Platform: "tiktok", Handle: "@almaleek6", URL: "https://tiktok.com/@almaleek6", Audience: "244.8K followers · 2.4M likes — comedy & culture"}, {Platform: "facebook", Handle: "Al Maleek Official", URL: "https://facebook.com/almaleekofficial", Audience: "177.8K followers — the community"}, {Platform: "instagram", Handle: "@almaleek88", URL: "https://instagram.com/almaleek88", Audience: "12K followers — skits & behind the scenes"}, {Platform: "youtube", Handle: "Maleek Cinema", URL: "https://youtube.com/@maleek_cinema", Audience: "1.3K subscribers — films & long-form"}, {Platform: "snapchat", Handle: "@al_maleek10", URL: "https://snapchat.com/@al_maleek10", Audience: "Spotlight skits"}},
		Home: HomeContent{
