...
/**
 * Brand-styled replacement for the native <select>: same form semantics
 * (hidden input carries the value) but the dropdown is ours, not the OS's.
 */
export function Select({
  ...
  return (
    <div
      ref={rootRef}
      className={["alm-select", className].filter(Boolean).join(" ")}
    ...
    >
      ...
      >
        ...
        <span className="alm-select-chevron" aria-hidden="true" />
      </button>
